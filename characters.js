...
export class Enemy {
  ...
  animate(players) {
    ...
    if (playerInRange) {
      ...
      if (playerInFollowRange) {
        ...
        // Follow the player
        this.position.x += (dx / 100) * playerVelocity;
        this.position.y += (dy / 100) * playerVelocity;
        this.state = "walk";
  ...
  animate() {
    ...
    if (distance > 0) {
      this.position.x += (dx / distance) * this.velocity;
      this.position.y += (dy / distance) * this.velocity;
    }
